...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  const roleBadge: Record<string, string> = {
    ...
    PROJECT_MANAGER: 'bg-blue-50 text-blue-600 border border-blue-200',
    DEVELOPER: 'bg-green-50 text-green-600 border border-green-200',
  };
    ...
    <aside className="w-60 bg-white border-r border-gray-100 flex flex-col h-screen">
      <div className="px-5 py-5 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm leading-none">Flowspace</p>
            <p className="text-xs text-gray-400 mt-0.5">Project Dashboard</p>
          </div>
        </div>
        {onClose && (
      ...
      <div className="p-3 border-t border-gray-100">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-gray-50 mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className={`text-xs px-1.5 py-0.5 rounded-md font-medium ${roleBadge[user?.role || 'DEVELOPER']}`}>
